      ...
      <div class="container">
        <div class="row mb-5 align-items-center">
          <div class="col-md-12 col-lg-6 mb-4 mb-lg-0" data-aos="fade-up">
            <h2>Ansel Adams-</h2>
            <i><p class="mb-0">"You don't take a photograph, you make it"</p></i>
          </div>
        ...
        <?php 
          ...
          $data_koleksi = mysqli_query($conn, "SELECT * FROM koleksi WHERE category_col = 'photography' ORDER BY col_id DESC");
