      ...
      <div class="container">
        <div class="row mb-5 align-items-center">
          <div class="col-md-12 col-lg-6 mb-4 mb-lg-0" data-aos="fade-up">
            <h2>Pablo Picasso-</h2>
            <i><p class="mb-0">"Sculpture is the art of the intelligence"</p></i>
          </div>
        ...
        <?php 
          ...
          $data_koleksi = mysqli_query($conn, "SELECT * FROM koleksi WHERE category_col = 'sculpture' ORDER BY col_id DESC");
            while ($d = mysqli_fetch_array($data_koleksi)) {  
          ?>
            <div class="item sculpture col-sm-6 col-md-4 col-lg-4 mb-4">
